from nb15.drivers.base_model_nb15 import base_model_nb15
from nb15.drivers.transfer_model_nb15 import transfer_model_nb15
from nb15.parameters_nb15 import parameters
...
for _, n in enumerate([x/100 for x in range(1, int(parameters['base_model']['noise_multiplier']*10)+1)]):
    ...
    model = base_model_nb15(save_model=True, model_folder='models/experiment_scenario_b', use_tf_privacy=True, noise_multiplier=n)
    # Perform Transfer Learning with Differential Privacy
    transfer_model_nb15(model, model_folder='models/experiment_scenario_b', use_tf_privacy=True, noise_multiplier=n)
