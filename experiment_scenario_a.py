from drivers.base_model_sa import base_model_sa
...
model = base_model_sa(save_model=True, model_folder='models/experiment_scenario_a', use_np_noise_privacy=True)
# Perform Transfer Learning to establish baseline performance on plaintext
transfer_model_emnist(model, model_folder='models/experiment_scenario_a')
...
#     model = base_model_sa(save_model=True, model_folder='models/experiment_scenario_b', use_tf_privacy=True, noise_multiplier=n)
